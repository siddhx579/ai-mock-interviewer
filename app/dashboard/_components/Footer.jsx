...
function Footer() {
    return (
        <footer className="flex flex-col items-center bg-gradient-to-r from-[#212631] to-[#4E576A] text-center text-surface">
            <div className="container px-6 pt-2">
                <div className="flex justify-center space-x-2">
                    <a
                        href="mailto:siddhantkapoor579@gmail.com"
                        type="button"
                    ...
                    <a
                        href="https://github.com/siddhx579"
                        target="_blank"
                        type="button"
